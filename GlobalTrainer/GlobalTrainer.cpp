...
class GlobalTrainer_NPC : public CreatureScript
{
public:
	GlobalTrainer_NPC() : CreatureScript("GlobalTrainer_NPC") { }
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
	{
		...
		if (sender == GOSSIP_SENDER_MAIN)
		{
			...
			case 2: // Reset Talents
				...
				creature->Whisper("Yout talents has been reset.", LANG_UNIVERSAL, player);
				break;
			}
		}
		return true;
...
void AddSC_GlobalTrainer_NPC()
{
	new GlobalTrainer_NPC();
}